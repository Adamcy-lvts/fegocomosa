    ...
    public function run()
    {
        if (User::count() == 0) {
            ...
            User::create([
                ...
                'profile_photo_path'=> 'profile-photos/musty_profile.jpg',
                'gender_id'         =>  1,
                'marital_status_id' =>  1,
                'address'           => 'New G.R.A Maiduguri, Borno State',
                'phone'             => '08069550775',
            ...
            User::create([
                ...
                'last_name'         => 'Abatcha',
                'profile_photo_path'=> 'profile-photos/becky.jpg',
                'date_of_birth'     =>  $myBirthDate,
                'about_you'         => '',
                'gender_id'         =>  1,
                'marital_status_id' =>  2,
             ...
             User::create([
                ...
                'date_of_birth'     =>  $myBirthDate,
                'about_you'         => '',
                'profile_photo_path'=> 'profile-photos/amir_pf.jpg',
                'gender_id'         =>  1,
                'marital_status_id' =>  1,
             ...
             User::create([
                ...
                'date_of_birth'     =>  $myBirthDate,
                'about_you'         => '',
                'profile_photo_path'=> 'profile-photos/impo_pf.jpg',
                'gender_id'         =>  1,
                'marital_status_id' =>  2,
                ...
                'city_id'           => 170,
                'profession'        => 'Teacher',
                'workplace'        =>  'Khalil Integrated Academy',
                'jss_class_id'         => 6,
                'sss_class_id'         => 6,
                'house_id'          => 2,
                'potrait_image'     => 'impo.jpg',
                'entry_year_id'     => 1,
                'graduation_year_id'=> 1,
                'password'          => bcrypt('swifty1989'),
                'remember_token'    => Str::random(60),
            ...
            User::create([
                ...
                'date_of_birth'     =>  $myBirthDate,
                'about_you'         => '',
                'profile_photo_path'=> 'profile-photos/L_Caprice_2.jpg',
                'gender_id'         =>  1,
                'marital_status_id' =>  2,
