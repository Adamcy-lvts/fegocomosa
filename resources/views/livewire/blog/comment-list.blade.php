<div>
    ...
    <div class="antialiased ">
        <h3 class="mb-4 text-lg font-semibold text-gray-900">{{ $comments->count() }} Comments</h3>
                    ...
                    @foreach ($comments as $comment)
                        @if ($comment->parent_id === null)
                            <div class="flex flex-row mb-3">
                                ...
                                <div class="flex-1 border rounded-lg px-4 py-2  sm:py-4 leading-relaxed">
                                    <div class="text-left">
                                    ...
                                    <div class="text-xs flex justify-between ">
                                        ...
                                        @if ($comment->user->id === auth()->user()->id)
                                            <div class="flex gap-2">
                                                <x-button xs wire:click="edit({{ $comment->id }})" flat
                                                    label="EDIT" />
