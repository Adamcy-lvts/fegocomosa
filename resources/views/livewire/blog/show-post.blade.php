<div>
    ...
    <section class="text-gray-600 body-font relative">
        <div class="w-full  p-16  bg-gray-600 ">
            <div class=" md:w-8/12 mx-auto">
                <h1 class="antialiased lg:text-7xl text-3xl mb-5 font-semibold text-gray-200 font-mono">
                    {{ $post->title }}
                </h1>
                <h3 class="antialiased text-2xl text-gray-200 font-mono">True fans will remember these moments all too
                    well.
                </h3>
            </div>
        </div>
        <div class="container px-5 py-24 pt-0 mx-auto flex flex-col">
            ...
            <div class="lg:w-5/6 mx-auto">
                <div class="flex p-5 gap-3">
                    ...
                    <i class="fa-thin fa-chevron-right"></i>
                    <a class=" text-base text-gray-500 font-bold">{{ $post->title }}</a>
                </div>
                <div class="flex flex-col sm:flex-row mt-10">
                    ...
                    <div
                        ...
                        <h3 class="text-sm font-bold">Posted : {{ $post->created_at->toFormattedDateString() }}
                        </h3>
