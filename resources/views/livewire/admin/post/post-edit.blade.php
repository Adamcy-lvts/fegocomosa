<div>
    ...
    <x-card title="Edit Post">
        ...
        <form enctype="multipart/form-data">
            ...
            <x-input label="Post Title" wire:model.defer="title" placeholder="Post Title" />

            <x-native-select label="Category" placeholder="Category" wire:model.defer="selectedCategory">
            ...
            <div class="sm:col-span-6 mb-3">
                ...
                <div wire:ignore>
                    <textarea id="body" data-text=@this wire:model.defer="body" label="Body">{{ $body }}</textarea>
                </div>
            </div>
            <div class="col-span-1 sm:col-span-2 sm:grid sm:grid-cols-2 sm:gap-5">
                <x-toggle label="Status" wire:model.defer="status" />

                <x-toggle label="Featured" wire:model.defer="featured" />
            </div>
            <x-slot name="footer">
