<div>
    @if (auth()->user()->hasRole(['Super-Admin', 'admin']))
        ...
        <div class="dark:text-gray-400">
            ...
            @if ($checkPageItems)
                <div>
                    ...
                    @else
                        You have selected <strong>{{ count($checkedProjects) }}</strong> records, do you wan to select
                        All
        ...
        <x-modal.card max-width="5xl" title="Project" blur wire:model="showModalForm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="col-span-1  md:col-span-3 md:grid md:grid-cols-2 md:gap-6">
                    ...
                    <x-inputs.currency label="Budget" placeholder="Budget" wire:model.defer="budget" />
                ...
                <div class="col-span-1  md:col-span-3 md:grid md:grid-cols-2 md:gap-6">
                    ...
                    <x-input type="number" label="Progress Indicator" placeholder="Progress Indicator"
            ...
            <div class="sm:col-span-6">
                <div class="w-full m-2 p-2">
                    ...
                    @if ($postedProjectImage)
                        Project Image:
                        <img width="50%" src="{{ asset('storage/projects_images/' . $postedProjectImage) }}">
                    @endif
                    ...
                    <div class="flex flex-row m-8 ">
                        ...
                        @foreach ($projectImages as $key => $projectImage)
                            <div class="flex flex-col gap-3">
                                ...
                                <x-input placeholder="Caption" wire:model.defer="captions.{{ $key }}" />
                            </div>
                        @endforeach
                    </div>
                @endif
