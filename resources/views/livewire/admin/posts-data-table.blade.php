<div>
    @if (auth()->user()->hasRole(['Super-Admin', 'admin', 'writer']))
        <x-slot name="header">
                    ...
                    <tbody class="divide-y divide-slate-700">
                        @forelse ($posts as $post)
                            <tr class="divide-y divide-slate-700">
                                <td class="px-3 py-2  ">
                                    <x-jet-checkbox value="{{ $post->id }}" wire:model="checkedPosts">
                                    </x-jet-checkbox>
                                </td>
            ...
            <x-slot name="footer">
                @if ($postId)
                    <div class="flex items-center gap-x-3 justify-end">
                        ...
                        <x-button type="submit" wire:click="updatePost" label="Update"
