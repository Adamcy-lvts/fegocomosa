<div class="space-y-8  mt-10">
    <x-errors />
    <form wire:submit.prevent="storeMember" enctype="multipart/form-data">
        <x-card title="Member Information">
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                <div class="col-span-1  md:col-span-3 md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <x-datetime-picker without-time label="Year of Gradution" placeholder="Year of Gradution"
                ...
                <div class="col-span-1  md:col-span-3 md:grid md:grid-cols-3 md:gap-6">
                    <x-input label="Jss Class" placeholder="For example Jss 1Q - 3Q" wire:model.defer="jssClass" />
                    <x-input label="Sss Class" placeholder="For example Sss 1Q - 3Q" wire:model.defer="sssClass" />
            ...
            <x-slot name="footer">
                <div class="flex items-center gap-x-3 justify-end">
                    ...
                    <x-button type="submit" label="Create" wire:loading.attr="disabled" />
                </div>
            </x-slot>
        </x-card>
    </form>
