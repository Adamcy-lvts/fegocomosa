            ...
            @foreach ($upComingEvents as $event)
                <div class="carousel-cell">
                    ...
                    <div class="inner">
                        ...
                        <h3 class="subtitle"><span class="font-semibold">Date:</span>
                            {{ $eventDate->format('l jS \\of F Y') }}</h3>
                        <h3 class="subtitle"><span class="font-semibold">Time:</span> {{ $eventTime->format('h:i A') }}
                        </h3>
