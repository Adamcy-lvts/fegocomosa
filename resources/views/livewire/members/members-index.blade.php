<div>
    ...
    <div class=" container mx-auto px-10">
        ...
        <span class="text-xs xs:text-sm mb-4 text-gray-300">
            {{ $members->links() }}
        </span>
        ...
        <span class="text-xs xs:text-sm mb-8 text-gray-300">
            {{ $members->links() }}
        </span>
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                        ...
                        <a class="link" target="_blank" href="{{ $facebook }}"
                        ...
                        <a class="link" target="_blank" href="{{ $instagram }}"
                        ...
                        <a class="link" target="_blank" href="{{ $telegram }}"
                        ...
                        <a class="link" target="_blank" href="{{ $whatsapp }}"
                        ...
                        <a class="link" target="_blank" href="{{ $linkedin }}"
                        ...
                        <a class="link" href="{{ $website }}" data-tippy-content="@website_handle"><svg
                                class="h-5 md:h-7 fill-current text-gray-600 hover:text-green-700" role="img"
