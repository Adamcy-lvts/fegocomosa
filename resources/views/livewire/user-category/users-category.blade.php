<div>
    <x-slot name="header">
        <div class="flex gap-3">
            <a class=" text-base text-gray-500 " href="{{ route('category.index') }}">Categories</a>
            <i class="fa-thin fa-chevron-right"></i>
            <a class=" text-base text-gray-500 font-bold">{{ $category->name }}</a>
            <i class="fa-thin fa-chevron-right"></i>
            <a class=" text-base text-gray-500 ">Members</a>
