                ...
                <div class="w-full md:w-2/6 border-0 md:border-r pt-10">
                    ...
                    <ul class="mt-2 mb-10 text-sm">
                        <li class="flex gap-2 px-2 mt-1 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 326.403 567.998"
                                class="w-4 fill-gray-700 hover:fill-green-600">
                                <path
                    ...
                    {{-- <ul class="mt-2 mb-10 text-sm">
                        @foreach ($member->skills as $skill)
                            <li class="px-2 mt-1">{{ $skill->skill_name }}</li>
                        @endforeach
                    </ul> --}}
                    ...
                    <div class="mb-10">
                        ...
                        <div class=" ">
                            ...
                            <div class="progress-container text-sm pr-3">
                                <!--progress bar-->
                                @foreach ($member->skills as $skill)
                                    <div class="progress-bar w-full " data-effect="1" data-value="{{ $skill->rating }}"
                    ...
                    <section>
                        ...
                        <div class="flex gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 540.95 608.857"
                                class="w-7 fill-gray-700 hover:fill-green-600">
                                <g>
                                    <path
                                ...
                                <div class="flex mb-12">
                                    ...
                                    <div class="flex-grow pl-7">
                                        ...
                                        <h3 class="text-sm">{{ $experience->job_title }} |
                                            ...
                                            {{ Carbon\Carbon::parse($experience->completion_date)->format('Y') }} </h3>
                                ...
                                <div class="flex mb-12">
                                    ...
                                    <div class="flex-grow pl-7 ">
                                        ...
                                        <p class="flex justify-between text-sm">
                                            <span class="text-sm capitalize ">{{ $education->field_of_study }}</span>
