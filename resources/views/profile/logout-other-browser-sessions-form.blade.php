<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Manage and log out your active sessions on other browsers and devices.') }} <br>
        ...
        <div class="flex items-center mt-5">
            ...
            <x-button green label="{{ __('Log Out Other Browser Sessions') }}" wire:click="confirmLogout"
