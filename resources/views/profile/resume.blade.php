        ...
        <div>
            <x-slot name="header">
                <div class="flex gap-3">
                    <a class=" text-base text-gray-500 " href="{{ route('members') }}">Members</a>
                    <i class="fa-thin fa-chevron-right"></i>
                    <a class=" text-base text-gray-500 ">Resume</a>
                    <i class="fa-thin fa-chevron-right"></i>
                    <a
                        class=" text-base text-gray-500 font-bold">{{ $member->first_name . ' ' . $member->last_name }}</a>
            ...
            <div class="bg-white md:w-8/12 mx-auto border border-gray-300 rounded-sm shadow-lg py-10 w-full mt-10 mb-10">
                ...
                <header class="px-10 border-b">
                        ...
                        <li>
                            ...
                            <a href="https://dev.to/"
                                ...
                                <svg class="w-5 h-5" role="img" aria-hidden="true"
                                    preserveAspectRatio="xMidYMid meet" viewBox="0 32 447.99999999999994 448"
                                    xmlns="http://www.w3.org/2000/svg" width="2500" height="2321">
                                    <g fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="flex flex-col gap-9 lg:flex-row mb-2 justify-between items-center">
                        <div class="w-full  md:w-2/6">
                            <div class="bg-cover mx-auto md:m-0 bg-no-repeat rounded-full h-52 w-52"
                ...
                <main class="flex flex-col px-10 md:flex-row md:gap-x-10 ">
                    <div class="w-full md:w-2/6 border-0 md:border-r pt-10">
                        ...
                        <ul class="mt-2 mb-10 text-sm">
                            <li class="flex gap-2 px-2 mt-1 mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                    viewBox="0 0 326.403 567.998" class="w-4 fill-gray-700 hover:fill-green-600">
                                    <path
                                ...
                                <a href="tel:+821023456789" class="block">{{ $member->phone }}</a>
                            </li>
                            <li class="flex gap-2 px-2 mt-1 mb-4 text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 604 440.95"
                                    class="w-5 fill-gray-700 hover:fill-green-600">
                                    <g>
                                        <path
                                ...
                                <a href="mailto:" class="block">{{ $member->email }}</a>
                            </li>
                            <li class=" flex gap-2 px-2 mt-1 mb-4 text-sm">
                                ...
                                <span class="block">{{ $member->address }}</span>
                            </li>
                        </ul>
                        <!-- skills -->
                        {{-- {{ dd() }} --}}
                        ...
                        <strong class="text-xl font-medium uppercase">Interests & Hobbies</strong>
                        <ul class="mt-2 mb-10 text-sm">
                            @foreach ($member->hobbies as $hobby)
                                <li class="px-2 mt-1">{{ $hobby->hobby_name }}</li>
                            @endforeach
                        </ul>

                        <strong class="text-xl font-medium uppercase">references</strong>
                        <ul class="mt-2 mb-10">
                            @foreach ($member->references as $reference)
                                <ul class="mb-5">
                                    <li class="flex gap-2 px-2  mt-1">
                                        {{ $reference->full_name }}
                                    </li>
                                    <li class="px-2 mt-1 text-sm italic">{{ $reference->job_title }}</li>
                                    <li class=" px-2 mt-1 text-sm italic">
                                        {{ $reference->email }}
                                    </li>
                                </ul>
                            @endforeach
                    ...
                    <!-- info -->
                    <div class="w-full md:w-4/6 pt-10">
                        <section>
                            <!-- about me -->
                            <div class="flex gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                    viewBox="0 0 540.95 608.857" class="w-7 fill-gray-700 hover:fill-green-600">
                                    <g>
                                        <path
                                ...
                                <h2 class="text-2xl pb-1 border-b font-semibold uppercase ">About</h2>
                            </div>
                            <p class="mt-4 mb-4 text-sm">{{ $member->about_you }}</p>

                        </section>

                        <section>
                            <!-- Personal Info -->
                            <div class="flex md:gap-10 md:flex-row flex-col text-sm">
                        ...
                        <section>
                            ...
                            @if ($member->experiences->isNotEmpty())
                                <div class="flex gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                        viewBox="0 0 650.384 584.377" class="w-7 fill-gray-700 hover:fill-green-600">
                                        <g>
                                            <path
                                    ...
                                    <h2 class="text-2xl mt-4 pb-1 mb-2 border-b uppercase  font-semibold">
                                        Work Experiences
                                    </h2>
                                </div>
                                <div class="flex flex-col relative ">
                                    @foreach ($member->experiences as $experience)
                                        <div class="flex mb-12">
                                            ...
                                            <div
                                                class="flex-shrink-0 w-5 h-5 rounded-full bg-gray-200 inline-flex items-center justify-center text-white relative z-10">

                                                <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                                    viewBox="0 0 526.001 525.994" stroke-width="2" class="w-4 h-4">
                                                    <g>
                                                        <path
                                            ...
                                            <div class="flex-grow pl-7">
                                                <h2
                                                    class="font-medium title-font text-sm text-gray-900 mb-1 uppercase  tracking-wider">
                                                    {{ $experience->employer }}
                                                </h2>
                        ...
                        <section>
                            ...
                            <div class="flex gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                    viewBox="0 0 746.417 422.324" class="w-9 fill-gray-700 hover:fill-green-600">
                                    <g>
                                        <path
                                ...
                                <h2 class="text-2xl mt-6 mb-3 pb-1 border-b uppercase font-semibold">Education</h2>
                            </div>
                            <div class="flex flex-col  relative ">
                                @foreach ($member->educations as $education)
                                    <div class="flex mb-12">
                                        <div
                                            class="h-full w-5 absolute inset-0 flex mt-5 ml-1 items-center justify-center">
                                            <div class="h-full w-0.5 bg-gray-200 pointer-events-none"></div>
                                        </div>
                                        <div
                                            class="flex-shrink-0 w-5 h-5 rounded-full ml-1 bg-gray-200 inline-flex items-center justify-center text-white relative z-10">
                                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                                viewBox="0 0 526.001 525.994" stroke-width="2" class="w-4 h-4">
                                                <g>
                                                    <path
                                        ...
                                        <div class="flex-grow pl-7 ">
                                            ...
                                            <p class="flex justify-between text-sm">
                                                <span
                                                    class="text-sm capitalize ">{{ $education->field_of_study }}</span>
                ...
                <footer class="mt-6">
                    <p class="bg-gray-600 text-white text-center text-sm pt-2">The best way to predict the future is to
                        create it. <small>- Abraham Lincoln</small>
                    </p>
