@guest
    <header class="text-gray-700 body-font border-b border-gray-200 bg-white ">
        <div class="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <x-button href="{{ route('login') }}" outline green icon="arrow-circle-right" label="Sign In"
                class=" ml-4 inline-flex items-center  py-1 px-3  rounded text-base mt-4 md:mt-0" />
            <x-button href="{{ route('register') }}" outline green icon="arrow-circle-up" label="Register"
                class=" ml-4 inline-flex items-center  py-1 px-3  rounded text-base mt-4 md:mt-0" />
