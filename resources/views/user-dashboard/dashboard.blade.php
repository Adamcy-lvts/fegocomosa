                    ...
                    <div class="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
                        <div class="border-b px-6">
                            <div class="flex justify-between -mb-px">
                                ...
                                <div class="hidden lg:flex">
                                    ...
                                    <button type="button"
                                        class="appearance-none py-4 text-gray-500 border-b border-transparent hover:border-gray-500 mr-6">
                                ...
                                <div class="flex text-sm">
                                    <button type="button"
                                        class="appearance-none py-4 text-gray-500 border-b border-transparent hover:border-gray-500 mr-3">
                                        1M
                                    </button>
                                    <button type="button"
                                        class="appearance-none py-4 text-gray-500 border-b border-transparent hover:border-gray-500 mr-3">
                                    ...
                                    <button type="button"
                                        class="appearance-none py-4 text-blue-600 border-b border-blue-500 mr-3">
                                        1M
                                    </button>
                                    <button type="button"
                                        class="appearance-none py-4 text-gray-500 border-b border-transparent hover:border-gray-500 mr-3">
                        ...
                        <div class="flex items-center px-6 lg:hidden">
                            <div class="flex-grow flex-no-shrink py-6">
                                ...
                                <div class="text-green-400-light text-sm">
                        ...
                        <div class="hidden lg:flex">
                                ...
                                <div class="border-r">
                                    <div class="text-gray-500 mb-2">
                                        <span class="text-3xl align-top"><span
                                                class="text-green-400 align-top">+</span>CA$</span>
                            ...
                            <div class="w-1/3 text-center py-8">
                                <div>
                                    <div class="text-gray-500 mb-2">
                                        <span class="text-3xl align-top"><span
                                                class="text-green-400 align-top">+</span></span>
                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full mb-6 lg:mb-0 lg:w-1/2 px-4 flex flex-col">
                            <div
                                ...
                                <div class="flex-grow flex px-6 py-6 text-gray-500er items-center border-b -mx-4">
                                    <div class="w-2/5 xl:w-1/4 px-4 flex items-center">
                                        <div class="rounded-full bg-orange-400 inline-flex mr-3">
                                            <svg class="fill-orange-400 text-white h-8 w-8 block"
                                    ...
                                    <div class="hidden md:flex lg:hidden xl:flex w-1/4 px-4 items-center">
                                        <div class="bg-orange-500 h-2 rounded-full flex-grow mr-2"></div>
                                        100%
                                    </div>
